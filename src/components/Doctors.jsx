...
const doctors = [
  {
    ...
    description: `डॉ. संतोष कुमार ओझा 18 वर्षों के एक अत्यंत अनुभवी गुदा रोग, क्षारसूत्र द्वारा एवं लेज़र ऑपरेशन के विशेषज्ञ आयुर्वेदिक चिकित्सक हैं। उन्हें पाइल्स (बवासीर), फिस्टुला (भगन्दर), फिशर, पाइलोनाइडल साइनस, रेक्टल प्रोलैप्स, हाइपरट्रॉफाइड पैपिला, रेक्टल पॉलिप, अल्सरेटिव कोलाइटिस, मलद्वार की टी.बी. आदि अन्य गुदा रोगों के उपचार में कई वर्षों का अनुभव है।
    
डॉ. ओझा आयुर्वेद की प्राचीन एवं प्रभावी क्षारसूत्र चिकित्सा पद्धति के विशेषज्ञ हैं, जिसके माध्यम से बड़े जटिल ऑपरेशन द्वारा गुदा रोगों का सफल इलाज किया जाता है।

डॉ. ओझा ने आयुर्वेद चिकित्सा में उच्च शिक्षा प्राप्त की है और अनेक राष्ट्रीय एवं अंतरराष्ट्रीय चिकित्सा सम्मेलनों (मेडिकल कॉन्फ्रेंस) में भाग लेकर अपने ज्ञान को निरंतर अद्यतन करते रहते हैं। वे मरीजों की समस्या को ध्यानपूर्वक समझकर उन्हें सुलभ एवं सुरक्षित, प्रभावी एवं व्यक्तिगत उपचार प्रदान करते हैं।
...
उनका मुख्य उद्देश्य मरीजों को कम समय में बेहतर स्वास्थ्य लाभ प्रदान करना तथा आयुर्वेदिक चिकित्सा के माध्यम से रोगों का स्थायी समाधान देना है।`,
    ...
    education: `बी.ए.एम.एस., पी.जी. डिपloma के. के. (क्षारकर्म)
शल्यतन्त्र विभाग, आई.एम.एस. बी.एच.यू., (वाराणसी)
डिप इन योग, बी.एच.यू. डिस्ट्रिक कन्सलटेन्ट (क्यू.ए.)
National Assessour of NQAS 
रजि. नं. - 50468 (उ.प्र.)`,
    expertise: ["Piles (Hemorrhoids)", "Fistula-in-ano", "Fissure", "Pilonidal Sinus", "Anorectal disorders", "rectal prolaps", "hypertrophy papila", "rectal polyp", "ulcerative colitis"],
    gallery: [
